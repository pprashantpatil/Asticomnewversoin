...
import { HolidaysDashComponent } from '../holidays-dash/holidays-dash.component';
...
export class HolidaysFormComponent implements OnInit {
  ...
  constructor(public DigiofficecorehrService: DigiofficecorehrService, private datepipe: DatePipe, public dialogRef: MatDialogRef<HolidaysDashComponent>,
