...
export class HranalyticsgraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    var options1 = {
      ...
      xaxis: {
        categories: ['Cost Allocation', 'Finance Department', 'Marketing', 'Sales']
      }
    }
    ...
    var chart6 = new ApexCharts(document.querySelector('#chart6'), donutChartOptions3)
    chart6.render();
  }
    ...
    if (event.target.value == 0) {
      ...
      this.DigiofficeService.GetAllStaffNew().subscribe(data => {
        ...
        const donutChartOptions1 = {
          ...
          series: [this.genderlist[0].staffMaleHeadCount, this.genderlist[0].staffFemaleHeadCount],
          labels: ['Male', 'Female'],
          // labels: ['Category 1', 'Category 2'],
          // Customize colors in the colors array
          colors: ['#3247d5', '#7a96ea'],
